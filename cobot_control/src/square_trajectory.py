...
class TrajectoryClient:
    ...
    def send_cartesian_trajectory(self):
        ...
        pose_list = [
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.366, -0.499, 0.519), geometry_msgs.Quaternion(-0.144, 0.676, -0.70, 0.147)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.266, -0.286, 0.893), geometry_msgs.Quaternion(-0.136, 0.684, -0.701, 0.145)
            )
        ]
        duration_list = [30.0, 60.0]
