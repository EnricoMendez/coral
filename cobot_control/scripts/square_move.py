...
class TrajectoryClient:
    ...
    def send_cartesian_trajectory(self):
        ...
        pose_list = [
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, -0.1, 0.4), geometry_msgs.Quaternion(0, 1, 0, 1 )
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, -0.1, 0.7), geometry_msgs.Quaternion(0, 1, 0, 1)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, -0.1, 0.7), geometry_msgs.Quaternion(-0.499, 0.480, -0.499, 0.521)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, 0.2, 0.7), geometry_msgs.Quaternion(-0.499, 0.480, -0.499, 0.521)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, 0.2, 0.7), geometry_msgs.Quaternion(0.707, 0.029, 0.707, -0.029)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, 0.2, 0.4), geometry_msgs.Quaternion(0.707, 0.029, 0.707, -0.029)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, 0.2, 0.4), geometry_msgs.Quaternion(0.516, 0.524, 0.474, 0.484)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, -0.1, 0.4), geometry_msgs.Quaternion(0.516, 0.524, 0.474, 0.484)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.4, -0.1, 0.4), geometry_msgs.Quaternion(0.026, 0.706, -0.032, 0.707)
            ),
        ]
        duration_list = [10.0, 15.0, 17.0, 22.0, 24.0, 29.0, 31.0, 36.0, 38.0]
