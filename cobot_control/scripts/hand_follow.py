...
class TrajectoryClient:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/hand_track/hand_position",Float32MultiArray,self.callback_coordinates)
    ...
    def callback_coordinates(self,msg):
        ...
        y = 0.48 #round(msg.data[2],4)
        z = round(msg.data[1],4)
        self.msg = 'coordinates ('+str(x)+','+str(y)+','+str(z)+')'
